...
--%>
<%@tag pageEncoding="UTF-8" description="更新ボタンを出力するウィジェット" %>
<%@ taglib prefix="button" tagdir="/WEB-INF/tags/widget/button" %>

<%-- ============================ 属性定義 =============================== --%>

<%@ attribute name="label"      description="ボタンに表示するラベルを設定する。省略した場合は、「更新」" rtexprvalue="true" %>
