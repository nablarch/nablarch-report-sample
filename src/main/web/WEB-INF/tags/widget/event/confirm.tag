...
<%@ attribute name="stop"       description="イベントを停止するかどうか(デフォルトはtrue)" rtexprvalue="true" type="Boolean"%>
<%@ attribute name="revert"     description="入力値を復元するかどうか(デフォルトはtrue)" rtexprvalue="true" type="Boolean"%>
