...
public class PasswordAuthenticator implements Authenticator {
     ...
     *
     * @throws please.change.me.common.authentication.AuthenticationFailedException ユーザIDまたはパスワードに一致するユーザが見つからない場合
     * @throws please.change.me.common.authentication.UserIdLockedException ユーザIDがロックされている場合。この例外がスローされる場合は、まだ認証を実施していない。
     * @throws please.change.me.common.authentication.PasswordExpiredException パスワードが有効期限切れの場合。この例外がスローされる場合は、古いパスワードによる認証に成功している。
     */
